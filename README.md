...
Ensure that your OS and drivers support the settings change. Modifying the Registry carries some risk, so it's recommended to back up the Registry before making changes.
